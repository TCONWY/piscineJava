...
public class Program {
    ...
    public static void main(String[] args) throws FileNotFoundException, SQLException {
        ...
        User creator = new User(4L, "Gachi", "000000", new ArrayList<>(), new ArrayList<>());
        User author = creator;
        Chatroom room = new Chatroom(3L, "dungeon", us.findById(3L).get(), new ArrayList<>());
        Message message = null;
        try {
            message = new Message(-1L, creator, room, "Hello!", LocalDateTime.now());
            mes.save(message);
            System.out.println(message.getId());
            System.out.println(us.findById(4L));
